...
export const Vortex = (props: VortexProps) => {
    ...
    const particlePropsLength = useMemo(() => particleCount * particlePropCount, [particleCount, particlePropCount]);
    ...
    let particleProps = useRef<Float32Array>(new Float32Array(particlePropsLength));
    ...
    const initParticle = useCallback(
        ...
        [baseTTL, rangeTTL, baseSpeed, rangeSpeed, baseRadius, rangeRadius, baseHue, rangeHue, rand, randRange, center, rangeY]
    );
    ...
    }, [noise3D, lerp, drawParticle, checkBounds, initParticle, particleProps, noiseSteps, TAU, xOff, yOff, zOff]);
